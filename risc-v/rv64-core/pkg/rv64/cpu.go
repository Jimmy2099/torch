...
func (c *CPU) SetRegisterFloatAsFloat64(i uint64, f float32) { c.reg1[i] = math.Float64bits(f) }
func (c *CPU) GetRegisterFloatAsFloat64(i uint64) float32    { return math.Float64frombits(c.reg1[i]) }
